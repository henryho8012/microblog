...
class Config(object):
    ...
    MAIL_USERNAME = "henryho801212345@gmail.com" #os.environ.get('MAIL_USERNAME')
    MAIL_PASSWORD = "Abcde@12345-" # os.environ.get('MAIL_PASSWORD')
    ADMINS = ['henryho801212345@gmail.com']
